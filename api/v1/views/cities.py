...
def handle_cities(state_id=None, city_id=None):
    '''The handler for the cities endpoint.
    '''
    handlers = {
        'GET': get_cities,
        'DELETE': remove_city,
...
def get_cities(state_id=None, city_id=None):
    '''Retrieve the city with the given id or all cities in
...
def remove_city(state_id=None, city_id=None):
    '''Removes the city with the given id.
    '''
    if city_id:
        city = storage.get(City, city_id)
        if city:
...
def update_city(state_id=None, city_id=None):
    '''Updates city with the given id.
    '''
